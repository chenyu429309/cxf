			...
			<div class="tile-body">
				<div class="form-horizontal">
					<div class="row">
						...
						<div class="form-group col-md-3">
							<label class="col-sm-4 control-label" for="shift">Shift</label>
							<div class="col-sm-8">
								<select class="form-control editableSelect" id="shift">
					...
					<div class="row" style="margin-left: -7ex;">
						...
						<div class="form-group col-md-4" style="margin-left: 800px;">
							...
							<button type="button" class="btn btn-greensea downLoadByShift">下载</button>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="panel-group" id="accordion2">
		<div class="panel panel-default">
			...
			<div id="collapseOne2" class="panel-collapse collapse in">
				<div
					class="tile-body nopadding bg-transparent-white-1 Tables panel-body"
...
<script
	src="${pageContext.request.contextPath}/assets/js/home_shift_tables.js"></script>
<script
